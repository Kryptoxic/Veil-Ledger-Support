...
# Veil
DEFINES   += COIN_P2PKH_VERSION=70 COIN_P2SH_VERSION=5 COIN_FAMILY=1 COIN_COINID=\"Veil\" COIN_COINID_HEADER=\"VEIL\" COIN_COLOR_HDR=0xFCB653 COIN_COLOR_DB=0xFEDBA9 COIN_COINID_NAME=\"Veil\" COIN_COINID_SHORT=\"VEIL\" COIN_NATIVE_SEGWIT_PREFIX=\"sv\" COIN_KIND=COIN_KIND_VEIL COIN_FLAGS=FLAG_SEGWIT_CHANGE_SUPPORT
APPNAME ="Veil"
APP_LOAD_PARAMS += --path $(APP_PATH)
else
